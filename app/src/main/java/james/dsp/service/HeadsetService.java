...
/*			Log.i(DSPManager.TAG, "(Int)c0: " + Arrays.toString(bench_c0));
    ...
    public void onCreate() {
        ...
        Log.e("Liuhang",  "HeadsetService:" + "onCreate");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.e("Liuhang",  "HeadsetService:" + "onStartCommand"  + "| modeEffect:" + modeEffect + ",startId:" + startId + ",flags:" + flags);
        if (modeEffect == 0) {
            if (JamesDSPGbEf == null) {
                JamesDSPGbEf = new JDSPModule(0);
                if (JamesDSPGbEf.JamesDSP == null) {
    ...
    public IBinder onBind(Intent intent) {
        Log.e("Liuhang",  "HeadsetService:" + "onBind");
